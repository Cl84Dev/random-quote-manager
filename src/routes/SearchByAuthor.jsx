...
const SearchByAuthor = () => {
    ...
    return (
        <article className="by-author d-flex flex-column align-items-center p-3 m-3 rounded-2">
            ...
            {(quotes.length === 0 && !noSearching) && <div>No quote matches to your search.</div>}

            {quotes && quotes.map(quote => <SingleQuote key={quote._id} quote={quote}/>)}
        </article>
    )
}

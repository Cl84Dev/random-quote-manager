...
const AddQuote = () => {
  ...
  return (
    <article className="add-quote d-flex flex-column align-items-center rounded-2 shadow-lg m-3 p-3">
      ...
      <div className="add-quote-fields d-flex flex-column align-items-center rounded-2 shadow-lg m-3 p-3">
        <label>
        ...
        <button className="btn btn-primary my-3" onClick={sendQuote}>
          Add Quote
        </button>
      </div>
    </article>
